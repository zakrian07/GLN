    ...
    <div class="row">
        <div class="">
            <div class="panel panel-default">
                ...
                Edit Multi Language for loot reward web</div>
                <div class="panel-body">
               
                 <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							 <form class="form-horizontal" enctype ="multipart/form-data" role="form" method="post" action="{{env('REWARDS_API_URL')}}languages/{{$multi_language->id}}">
                                 {{method_field('patch')}}
                                {{ csrf_field() }}
...
$(document).on("submit", "form", function(event)
{
    ...
    $.ajax({
        ...
        success: function (data, status)
        {
                ...
                toastr.success('Multi Language is Updated');
